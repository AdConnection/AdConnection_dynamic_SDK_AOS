...
class DynamicBannerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.layout_dynamic_banner)

        adConnector = AdConnector(this, "caiDuDbMgE4v")
    }
    ...
    private fun requestDynamicBanner() {
        ...
        if (adConnector != null) adConnector.requestDynamicBannerView(600, 500, listener)
    }
